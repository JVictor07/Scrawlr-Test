...
export const UpvoteGroup = memo(({ row }: { row: UpvoteRow }) => {
  ...
  return (
    <div className="flex rounded-md items-center gap-3 justify-center w-full">
      <div className="flex gap-2 border-2 border-gray-200 p-2 min-h-13 rounded-md overflow-x-auto w-full">
